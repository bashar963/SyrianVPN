...
import com.sydev.vpnsyria.BuildConfig;
...
import com.sydev.vpnsyria.ui.activities.HomeActivity;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener {
    ...
    private void showNotification(final String msg, String tickerText, boolean lowpriority, long when, ConnectionStatus status) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            String NOTIFICATION_CHANNEL_ID = "com.sydev.vpnsyria";
            String channelName = " VPN Service";
            ...
            Notification notification = notificationBuilder
                    ...
                    .setContentTitle(getString(R.string.notification_title)+" "+mProfile.mName)
                    .setContentText(msg)
                    .setOnlyAlertOnce(true)
                    .setOngoing(true)
                    .setContentIntent(getLogPendingIntent())
                    .setWhen(when)
            ...
            int icon = R.drawable.ic_vpn_lock;
    ...
    private void jbNotificationExtras(boolean lowpriority,
        ...
        try {
            ...
            nbuilder.addAction(R.drawable.ic_close,
            ...
            if (mDeviceStateReceiver == null || !mDeviceStateReceiver.isUserPaused()) {
                ...
                nbuilder.addAction(R.drawable.ic_pause,
                        getString(R.string.pauseVPN), pauseVPNPending);

            } else {
                pauseVPN.setAction(RESUME_VPN);
                PendingIntent resumeVPNPending = PendingIntent.getService(this, 0, pauseVPN, 0);
                nbuilder.addAction(R.drawable.ic_play,
    ...
    public void updateByteCount(long in, long out, long diffIn, long diffOut) {
        DataTraffic.Companion.calcTraffic(this, in, out, diffIn, diffOut);
